...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=stealth, font=\small]
        ...
        \begin{scope}[shift={(0,0)}]
            \draw[->] (-1.5, {-1.5*tan(\ang)}) -- (2.5, {2.5*tan(\ang)}) node[right] {$\mathbf{n}$};
            ...
            \coordinate (C2) at (1.5, {1.5*tan(\ang)});
            \coordinate (S) at (0.8, {0.8*tan(\ang)});
        ...
        \begin{scope}[shift={(5.5,0)}]
            \draw[->] (-1.5, {-1.5*tan(\ang)}) -- (2.6, {2.6*tan(\ang)}) node[right] {$\mathbf{n}$};
            
            \coordinate (C1) at (0, 0);
            \coordinate (C2) at (1.15, {1.15*tan(\ang)});
            \coordinate (S) at (0.7, {0.7*tan(\ang)});
        ...
        \begin{scope}[shift={(11,0)}]
            \draw[->] (-1.5, {-1.5*tan(\ang)}) -- (2.8, {2.8*tan(\ang)}) node[right] {$\mathbf{n}$};
