...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            % Linear envelopes
            \addplot[dashed, gray, domain=0:17] {3.5 - 0.22918*x};
            \addplot[dashed, gray, domain=0:17] {-3.5 + 0.22918*x};
            
            % Drawing piecewise dry friction exact motion
            \addplot[thick, blue, domain=0:3.14159] { (3.5 - 0.36)*cos(deg(x)) + 0.36 };
            \addplot[thick, blue, domain=3.14159:6.28318] { (3.5 - 3*0.36)*cos(deg(x)) - 0.36 };
            \addplot[thick, blue, domain=6.28318:9.42477] { (3.5 - 5*0.36)*cos(deg(x)) + 0.36 };
            \addplot[thick, blue, domain=9.42477:12.56637] { (3.5 - 7*0.36)*cos(deg(x)) - 0.36 };
            \addplot[thick, blue, domain=12.56637:15.70796] { (3.5 - 9*0.36)*cos(deg(x)) + 0.36 };
            \addplot[thick, blue, domain=15.70796:17] { 0.10 }; % Megáll
            
            % Stop band
            \draw[fill=red, opacity=0.1] (0, -0.36) rectangle (17, 0.36);
            \draw[dashed, red] (0, 0.36) -- (17, 0.36);
            \draw[dashed, red] (0, -0.36) -- (17, -0.36);
            \node[red, above left] at (17, 0.36) {állósáv $\left(\pm\frac{F_s}{k}\right)$};
        \end{axis}
    \end{tikzpicture}
